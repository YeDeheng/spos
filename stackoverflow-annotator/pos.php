...
VALID_LABELS = 'NnOoSs^ZzLlMmVvAaRr!DdPp&TtXxYy#@~UuEe=Cc$,Gg?';	
LABEL_NAMES = {
		'N': 'common noun', 
		...
		'E': 'emoticon', 
		'=': 'program operators', 
		'C': 'code element or code snippet coded by the programmer himself(not API)', 
		'$': 'numeral', 
		',': 'punctuation', 
...
<title>StackOverflow POS Annotation (<?= $_SERVER['REMOTE_USER'] ?>)</title>
</head>
<body>
<form action="" method="post">
<h1>StackOverflow POS Annotation</h1>
...
<div class="instructions">
	...
	<p>NOTE: Important: if you are unsure about the correct tag, enter '?' </p>
</div>
